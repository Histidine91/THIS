...
local function UpdateRules()
	...
	label_chickens:SetCaption("Ships alive/killed : \255\0\255\0"..chickenCount.."\008/\255\255\0\0"..chickenKills)
	label_burrows:SetCaption("Starbases alive/killed : \255\0\255\0"..gameInfo[roostName .. "Count"].."\008/\255\255\0\0"..gameInfo[roostName .. "Kills"])
...
function ChickenEvent(chickenEventArgs)
  ...
  elseif (chickenEventArgs.type == "miniQueen") then
    waveMessage    = {}
    waveMessage[1] = "Command cruisers attacking!"
	waveTime = Spring.GetTimer()
  elseif (chickenEventArgs.type == "queen") then
    waveMessage    = {}
    waveMessage[1] = "The Imperator has warped in!"
    waveTime = Spring.GetTimer()
  end
end
